...
<body>
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="#"><img src="<?php echo BASE_URL; ?>public/img/tina_tran.jpeg" alt="" width="50"></a>
        </div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="<?php echo BASE_URL; ?>"><img src="<?php echo BASE_URL; ?>public/img/tina_tran.jpeg" alt="LOGO" width="70"></a>
                    </div>
                </div>
                <div class="col-lg-6">
