...
class PrincipalModel extends Query{
    ...
    public function getEstadosFind($id){
        $sql = "SELECT  * FROM estados WHERE id = $id";
        return $this->selectAll($sql);
    }

    public function getCiudadAll($id_estado){
        $sql = "SELECT  * FROM ciudades WHERE id_estado = $id_estado";
        return $this->selectAll($sql);
    }

    public function getmunicipiodAll($id_estado){
