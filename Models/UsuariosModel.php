...
class UsuariosModel extends Query{
    ...
    public function registrar($correo, $nombre, $apellido, $hash, $direccion, $tipo,$estado_id,$ciudade_id,$municipio_id,$parroquia_id)
    {
        $sql = "INSERT INTO usuarios (correo, nombre, apellido, clave, direccion, tipo,estado_id,ciudade_id,municipio_id,parroquia_id) VALUES (?,?,?,?,?,?,?,?,?,?)";
        $array = array($correo, $nombre, $apellido, $hash, $direccion, $tipo,$estado_id,$ciudade_id,$municipio_id,$parroquia_id);
