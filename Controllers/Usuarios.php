    ...
    public function registrar()
    {
        if (isset($_POST['nombre']) && isset($_POST['correo']) && isset($_POST['clave'])) {
            ...
            if (
                ...
                || empty($clave) || empty($direccion) || empty($estado_id)|| empty($ciudade_id)|| empty($municipio_id)|| empty($parroquia_id)
            ) {
                ...
                if (empty($id)) {
                    ...
                    if (empty($result)) {
                        $data = $this->model->registrar($correo, $nombre, $apellido, $hash, $direccion, $tipo,$estado_id,$ciudade_id,$municipio_id,$parroquia_id);
                        if ($data > 0) {
