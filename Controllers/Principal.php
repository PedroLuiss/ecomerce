...
class Principal extends Controller
{
    ...
    {
        if (isset($id) && !$id =="") {
            $estados = $this->model->getEstadosFind($id);
            $respuesta = array('data' => $estados,);
        }else{
            $estados = $this->model->getEstadosAll();
            $respuesta = array('data' => $estados,);
        }
      ...
      public function ciudad($id_estado)
      {
          if (isset($id_estado) && !$id_estado =="") {
            $estados = $this->model->getCiudadAll($id_estado);
            $respuesta = array('data' => $estados,);
          }else{
       ...
       {
           if (isset($id_estado) && !$id_estado =="") {
             $estados = $this->model->getmunicipiodAll($id_estado);
             $respuesta = array('data' => $estados,);
           }else{
        ...
        {
            if (isset($id_municipio) && !$id_municipio =="") {
              $estados = $this->model->getparroquiaAll($id_municipio);
              $respuesta = array('data' => $estados,);
            }else{
